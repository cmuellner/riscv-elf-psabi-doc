...
it's not suitable for building position-independent ELF objects (e.g. shared
libraries), please use medium position independent code model for such scenario.
